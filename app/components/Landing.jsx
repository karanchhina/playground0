...
const Landing = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen fixed top-0 left-0 right-0 bottom-0 bg-white z-30 text-gray-800 font-mono shadow-md">
            ...
            <div className="flex flex-col md:flex-row bg-gray-100 p-2 rounded-lg shadow-lg text-center w-3/5 max-w-2xl">
                ...
                <div className="w-full md:w-1/2 p-2 flex items-center justify-center text-md text-gray-800 shadow-md font-mono">
